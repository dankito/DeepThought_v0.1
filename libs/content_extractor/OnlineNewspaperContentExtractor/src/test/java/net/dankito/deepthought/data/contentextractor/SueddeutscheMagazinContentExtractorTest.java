...
public class SueddeutscheMagazinContentExtractorTest extends GermanOnlineNewspaperContentExtractorTestBase {
  ...
  protected net.dankito.deepthought.data.contentextractor.SueddeutscheMagazinContentExtractor importer = null;
  ...
  public void importNummerEinsDerWocheDruckluftArticle() {
    EntryCreationResult creationResult = testImportArticle("http://sz-magazin.sueddeutsche.de/texte/anzeigen/43365");
      testImportedArticleValues(creationResult, 3358, "22.07.15", "Der Laden, in dem sich die Leute am liebsten aufhalten, ist laut einer aktuellen Umfrage: die Buchhandlung.", "Druckluft",
  ...
  public void importDieSchoenstenStrandspaziergaengeDerWeltArticle() {
    ...
    testImportedArticleValues(creationResult, 6619, "28/2015", "Die schönsten Strandspaziergänge der Welt", "Wellengang",
  ...
  public void importDasZerquetschenVonEiernArticle() {
    ...
    testImportedArticleValues(creationResult, 9211, "41/2014", "Straßenprostitution in Spanien - Fotostrecke von Txema Salvans", "Das Zerquetschen von Eiern",
  ...
  public void importArticleWithTwoArtikelElements() {
    ...
    testImportedArticleValues(creationResult, 7815, "04.09.15", "Der britische Komponist Max Richter steht vor einer besonderen Uraufführung", "»Ein Pausenknopf für das Leben«",
