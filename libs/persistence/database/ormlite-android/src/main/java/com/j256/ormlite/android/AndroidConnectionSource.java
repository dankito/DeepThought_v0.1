...
/**
 * Android version of the connectionSource source. Takes a standard Android {@link SQLiteOpenHelper}. For best results, use
...
public class AndroidConnectionSource extends BaseConnectionSource implements ConnectionSource {
	...
	public DatabaseConnection getReadOnlyConnection() throws SQLException {
		/*
		 * We have to use the read-write connectionSource because getWritableDatabase() can call close on
		 * getReadableDatabase() in the future. This has something to do with Android's SQLite connectionSource management.
		 * 
	...
	public void releaseConnection(DatabaseConnection connection) {
		// noop since connectionSource management is handled by AndroidOS
	}
	...
	/**
	 * Set to enable connectionSource proxying. Set to null to disable.
	 */
