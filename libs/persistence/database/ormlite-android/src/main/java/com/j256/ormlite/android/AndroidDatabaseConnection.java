...
/**
 * Database connectionSource for Android.
 * 
...
public class AndroidDatabaseConnection implements DatabaseConnection {
	...
	/**
	 * Return whether this connectionSource is read-write or not (real-only).
	 */
	...
	public int insert(String statement, Object[] args, PropertyConfig[] argPropertyConfigs, GeneratedKeyHolder keyHolder)
		...
		try {
			...
			bindArgs(stmt, args, argPropertyConfigs);
	...
	public int update(String statement, Object[] args, PropertyConfig[] argPropertyConfigs) throws SQLException {
		return update(statement, args, argPropertyConfigs, "updated");
	}
	...
	public int delete(String statement, Object[] args, PropertyConfig[] argPropertyConfigs) throws SQLException {
		...
		return update(statement, args, argPropertyConfigs, "deleted");
	}
	...
	private int update(String statement, Object[] args, PropertyConfig[] argPropertyConfigs, String label) throws SQLException {
		SQLiteStatement stmt = null;
		try {
			stmt = db.compileStatement(statement);
			bindArgs(stmt, args, argPropertyConfigs);
	...
	private void bindArgs(SQLiteStatement stmt, Object[] args, PropertyConfig[] argPropertyConfigs) throws SQLException {
		if (args == null) {
			return;
		}
		for (int i = 0; i < args.length; i++) {
			...
			if (arg == null) {
				...
				SqlType sqlType = argPropertyConfigs[i].getSqlTypeOfFieldConverter();
				switch (sqlType) {
					case STRING :
					case LONG_STRING :
					case CHAR :
