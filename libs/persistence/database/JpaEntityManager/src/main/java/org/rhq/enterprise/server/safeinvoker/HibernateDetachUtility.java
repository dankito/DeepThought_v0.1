...
//  private static final Log LOG = LogFactory.getLog(HibernateDetachUtility.class);
  private static final Logger LOG = LoggerFactory.getLogger(HibernateDetachUtility.class);
      ...
      if (fieldValue instanceof HibernateProxy) {
        ...
        if (replacement == null) {
          ...
          try {
            ...
            try {
              Field idField = findDeclaredFieldInClassHierarchy(clazz, "id");
        ...
        if (fieldValue instanceof org.hibernate.collection.spi.PersistentCollection) {
          ...
          // cda: i don't know what this check was good for but for me all Collections should be initialized. Why settings them to null?
...
//          }
          ...
          if (fieldValue != null
              && (fieldValue.getClass().getName().contains("org.rhq") || fieldValue.getClass().getName().contains("net.deepthought.data.model") || fieldValue instanceof Collection
    ...
    for (PropertyDescriptor pd : pds) {
      ...
      if (!Hibernate.isInitialized(propertyValue)) {
        ...
        if ((propertyValue instanceof Collection)
            || ((propertyValue != null) && (propertyValue.getClass().getName().startsWith("org.rhq.core.domain") || propertyValue.getClass().getName().startsWith("net" +
            ".deepthought.data.model")))) {
  ...
  private static void setField(Object object, String fieldName, Object newValue) {
    try {
      Field f = findDeclaredFieldInClassHierarchy(object.getClass(), fieldName);
      if (f != null) {
  ...
  private static void nullOutField(Object value, String fieldName) {
    try {
      Field f = findDeclaredFieldInClassHierarchy(value.getClass(), fieldName);
      if (f != null) {
        // try to set the field this way
        f.setAccessible(true);
        f.set(value, null);
  ...
  private static Field findDeclaredFieldInClassHierarchy(Class clazz, String fieldName) throws NoSuchFieldException {
    Class tmpClass = clazz;
    NoSuchFieldException lastThrownException = null;
