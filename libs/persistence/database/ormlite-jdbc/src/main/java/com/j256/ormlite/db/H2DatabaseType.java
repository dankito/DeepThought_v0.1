...
public class H2DatabaseType extends BaseDatabaseType {
	...
	@Override
	protected void appendBooleanType(StringBuilder sb, PropertyConfig fieldType, int fieldWidth) {
		sb.append("TINYINT(1)");
	}

	@Override
	protected void configureGeneratedId(String tableName, StringBuilder sb, PropertyConfig fieldType,
