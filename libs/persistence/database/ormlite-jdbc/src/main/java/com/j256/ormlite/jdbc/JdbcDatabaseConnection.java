...
public class JdbcDatabaseConnection implements DatabaseConnection {
	...
	private static PropertyConfig[] noArgTypes = new PropertyConfig[0];
	...
	public CompiledStatement compileStatement(String statement, StatementType type, PropertyConfig[] argFieldTypes,
	...
	public int update(String statement, Object[] args, PropertyConfig[] argFieldTypes) throws SQLException {
		return update(statement, args, argFieldTypes, "update");
	}

	public int delete(String statement, Object[] args, PropertyConfig[] argFieldTypes) throws SQLException {
		// it's a call to executeUpdate
		return update(statement, args, argFieldTypes, "delete");
	}

	public <T> Object queryForOne(String statement, Object[] args, PropertyConfig[] argFieldTypes,
	...
	public long queryForLong(String statement, Object[] args, PropertyConfig[] argFieldTypes) throws SQLException {
	...
	private int update(String statement, Object[] args, PropertyConfig[] argFieldTypes, String label) throws SQLException {
	...
	private <T> Object queryForOne(String statement, Object[] args, PropertyConfig[] argFieldTypes,
	...
	private void statementSetArgs(PreparedStatement stmt, Object[] args, PropertyConfig[] argFieldTypes) throws SQLException {
		if (args == null) {
			return;
		}
		for (int i = 0; i < args.length; i++) {
			Object arg = args[i];
			int typeVal = TypeValMapper.getTypeValForSqlType(argFieldTypes[i].getSqlTypeOfFieldConverter());
			if (arg == null) {
