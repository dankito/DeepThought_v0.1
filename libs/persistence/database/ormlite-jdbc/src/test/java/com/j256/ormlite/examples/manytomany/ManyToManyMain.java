...
public class ManyToManyMain {
	...
	private void setupDatabase(ConnectionSource connectionSource) throws Exception {
		 ...
		 */
		userDao = Instances.getDaoManager().createDao(connectionSource, User.class);
		postDao = Instances.getDaoManager().createDao(connectionSource, Post.class);
		userPostDao = Instances.getDaoManager().createDao(connectionSource, UserPost.class);
