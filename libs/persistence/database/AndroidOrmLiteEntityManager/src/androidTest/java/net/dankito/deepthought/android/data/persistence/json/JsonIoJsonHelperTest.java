package net.dankito.deepthought.android.data.persistence.json;

import android.test.AndroidTestCase;

import com.j256.ormlite.jpa.StringHelper;

import net.dankito.deepthought.android.data.persistence.db.helper.ResourceHelper;
import net.deepthought.android.R;
import net.dankito.deepthought.android.data.persistence.db.helper.DataHelper;
