...
public class Between extends BaseComparison {
	...
	public Between(String columnName, PropertyConfig propertyConfig, Object low, Object high) throws SQLException {
	...
	public void appendValue(DatabaseType databaseType, StringBuilder sb, List<ArgumentHolder> argList)
		...
		appendArgOrValue(databaseType, propertyConfig, sb, argList, low);
		sb.append("AND ");
		appendArgOrValue(databaseType, propertyConfig, sb, argList, high);
	}
}
