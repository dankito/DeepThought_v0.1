 ...
 * {@link BaseFieldConverter#sqlArgToJava(com.j256.ormlite.jpa.PropertyConfig, Object, int)} method as well which converts from a SQL data to
 * java.
 * </p>
 * 
 * @author graywatson
...
public abstract class BaseDataType extends BaseFieldConverter implements DataPersister {
	...
	public abstract Object parseDefaultString(PropertyConfig propertyConfig, String defaultStr) throws SQLException;

	public abstract Object resultToSqlArg(PropertyConfig propertyConfig, DatabaseResults results, int columnPos)
			throws SQLException;
	...
	public Object resultStringToJava(PropertyConfig propertyConfig, String stringValue, int columnPos) throws SQLException {
		return parseDefaultString(propertyConfig, stringValue);
	}
}
