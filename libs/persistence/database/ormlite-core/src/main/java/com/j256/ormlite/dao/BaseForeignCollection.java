...
public abstract class BaseForeignCollection<T, ID> implements ForeignCollection<T>, Serializable {
	...
	private transient final PropertyConfig foreignPropertyConfig;
	...
	protected BaseForeignCollection(Dao<T, ID> dao, Object parent, Object parentId, PropertyConfig foreignPropertyConfig,
	...
	protected PreparedQuery<T> getPreparedQuery() throws SQLException {
		...
		if (preparedQuery == null) {
			...
			preparedQuery = qb.where().eq(foreignPropertyConfig.getColumnName(), fieldArg).prepare();
