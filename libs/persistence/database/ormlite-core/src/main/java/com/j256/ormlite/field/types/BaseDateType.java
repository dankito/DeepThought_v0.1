...
public abstract class BaseDateType extends BaseDataType {
	...
	protected static DateStringFormatConfig convertDateStringConfig(PropertyConfig propertyConfig,
			DateStringFormatConfig defaultDateFormatConfig) {
		if (propertyConfig == null) {
			return defaultDateFormatConfig;
		}
		DateStringFormatConfig configObj = (DateStringFormatConfig) propertyConfig.getDataTypeConfigObj();
		if (configObj == null) {
			return defaultDateFormatConfig;
		} else {
