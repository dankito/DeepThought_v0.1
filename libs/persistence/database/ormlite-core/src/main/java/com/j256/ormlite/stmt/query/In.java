...
public class In extends BaseComparison {
	...
	public In(String columnName, PropertyConfig propertyConfig, Iterable<?> objects, boolean in) throws SQLException {
		super(columnName, propertyConfig, null, true);
		this.objects = objects;
		this.in = in;
	}

	public In(String columnName, PropertyConfig propertyConfig, Object[] objects, boolean in) throws SQLException {
		super(columnName, propertyConfig, null, true);
	...
	public void appendValue(DatabaseType databaseType, StringBuilder sb, List<ArgumentHolder> columnArgList)
		...
		for (Object value : objects) {
			...
			super.appendArgOrValue(databaseType, propertyConfig, sb, columnArgList, value);
		}
		sb.append(") ");
	}
}
