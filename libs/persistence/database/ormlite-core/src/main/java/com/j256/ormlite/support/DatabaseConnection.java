...
public interface DatabaseConnection extends Closeable {
	...
	/**
	 * Execute a statement directly on the connectionSource.
	 * 
	 * @param resultFlags
	...
	/**
	 * Close the connectionSource to the database but swallow any exceptions.
	 */
	public void closeQuietly();

	/**
	 * Return if the connectionSource has been closed either through a call to {@link #close()} or because of a fatal error.
	 */
