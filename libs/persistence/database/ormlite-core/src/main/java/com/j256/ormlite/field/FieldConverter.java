...
public interface FieldConverter {
	 ...
	 */
	public Object javaToSqlArg(PropertyConfig propertyConfig, Object obj) throws SQLException;
	...
	/**
	 * This is usually just a call that takes the result from {@link #resultToSqlArg(com.j256.ormlite.jpa.PropertyConfig, DatabaseResults, int)}
	 * and passes it through {@link #sqlArgToJava(com.j256.ormlite.jpa.PropertyConfig, Object, int)}.
	 */
	 ...
	 *            Associated FieldType which may be null.
	 * @param sqlArg
	 *            SQL argument converted with {@link #resultToSqlArg(com.j256.ormlite.jpa.PropertyConfig, DatabaseResults, int)} which will not be
	 *            null.
	 */
