...
public enum DataType {
	 ...
	 */
	STRING(String.class, StringType.getSingleton()),
	/**
	 * Persists the {@link String} Java class.
	 */
	LONG_STRING(String.class, LongStringType.getSingleton()),
	/**
	 ...
	 */
	STRING_BYTES(String.class, StringBytesType.getSingleton()),
	/**
	 * Persists the boolean Java primitive.
	 */
	BOOLEAN(boolean.class, BooleanType.getSingleton()),
	/**
	 * Persists the {@link Boolean} object Java class.
	 */
	BOOLEAN_OBJ(Boolean.class, BooleanObjectType.getSingleton()),
	/**
	 * Persists the boolean Java primitive as a character in the database.
	 */
	BOOLEAN_CHAR(boolean.class, BooleanCharType.getSingleton()),
	/**
	 * Persists the boolean Java primitive as an integer in the database.
	 */
	BOOLEAN_INTEGER(boolean.class, BooleanIntegerType.getSingleton()),
	/**
	 ...
	 * </p>
	 */
	DATE(Date.class, DateType.getSingleton()),
	 ...
	 * </p>
	 */
	DATE_LONG(Date.class, DateLongType.getSingleton()),
	/**
	 ...
	 * </p>
	 */
	DATE_STRING(Date.class, DateStringType.getSingleton()),
	/**
	 * Persists the char primitive.
	 */
	CHAR(char.class, CharType.getSingleton()),
	/**
	 * Persists the {@link Character} object Java class.
	 */
	CHAR_OBJ(Character.class, CharacterObjectType.getSingleton()),
	/**
	 * Persists the byte primitive.
	 */
	BYTE(byte.class, ByteType.getSingleton()),
	/**
	 ...
	 */
	BYTE_ARRAY(byte[].class, ByteArrayType.getSingleton()),
	/**
	 * Persists the {@link Byte} object Java class.
	 */
	BYTE_OBJ(Byte.class, ByteObjectType.getSingleton()),
	/**
	 * Persists the short primitive.
	 */
	SHORT(short.class, ShortType.getSingleton()),
	/**
	 * Persists the {@link Short} object Java class.
	 */
	SHORT_OBJ(Short.class, ShortObjectType.getSingleton()),
	/**
	 * Persists the int primitive.
	 */
	INTEGER(int.class, IntType.getSingleton()),
	/**
	 * Persists the {@link Integer} object Java class.
	 */
	INTEGER_OBJ(Integer.class, IntegerObjectType.getSingleton()),
	/**
	 * Persists the long primitive.
	 */
	LONG(long.class, LongType.getSingleton()),
	/**
	 * Persists the {@link Long} object Java class.
	 */
	LONG_OBJ(Long.class, LongObjectType.getSingleton()),
	/**
	 * Persists the float primitive.
	 */
	FLOAT(float.class, FloatType.getSingleton()),
	/**
	 * Persists the {@link Float} object Java class.
	 */
	FLOAT_OBJ(Float.class, FloatObjectType.getSingleton()),
	/**
	 * Persists the double primitive.
	 */
	DOUBLE(double.class, DoubleType.getSingleton()),
	/**
	 * Persists the {@link Double} object Java class.
	 */
	DOUBLE_OBJ(Double.class, DoubleObjectType.getSingleton()),
	/**
	 ...
	 * automatically.
	 */
	SERIALIZABLE(Serializable.class, SerializableType.getSingleton()),
  /**
   * Persists an Enum Java class as its ordinal integer value. You can also specify the {@link #ENUM_STRING} as the
   * type.
   */
  ENUM_INTEGER(Enum.class, EnumIntegerType.getSingleton()),
	/**
	 * Persists an Enum Java class as its string value. You can also specify the {@link #ENUM_INTEGER} as the type.
	 */
	ENUM_STRING(Enum.class, EnumStringType.getSingleton()),
	/**
	 * Persists the {@link java.util.UUID} Java class.
	 */
	UUID(java.util.UUID.class, UuidType.getSingleton()),
	/**
	 * Persists the {@link BigInteger} Java class.
	 */
	BIG_INTEGER(BigInteger.class, BigIntegerType.getSingleton()),
  /**
   * Persists the {@link BigDecimal} Java class as a SQL NUMERIC.
   */
  BIG_DECIMAL_NUMERIC(BigDecimal.class, BigDecimalNumericType.getSingleton()),
	/**
	 * Persists the {@link BigDecimal} Java class as a String.
	 */
	BIG_DECIMAL(BigDecimal.class, BigDecimalStringType.getSingleton()),
	/**
...
//	DATE_TIME(Class.forName("joda.time.DateTime"), DateTimeType.getSingleton()),
  DATE_TIME(null, DateTimeType.getSingleton()),
  /**
	 ...
	 * </p>
	 */
	SQL_DATE(java.sql.Date.class, SqlDateType.getSingleton()),
	/**
	 * Persists the {@link java.sql.Timestamp} Java class. The {@link #DATE} type is recommended instead.
	 */
	TIME_STAMP(java.sql.Timestamp.class, TimeStampType.getSingleton()),
	/**
  ...
  private final Class type;
	...
	private DataType(Class type, DataPersister dataPersister) {
    this.type = type;
