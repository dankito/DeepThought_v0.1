...
public class SetValue extends BaseComparison {
	...
	public SetValue(String columnName, PropertyConfig propertyConfig, Object value) throws SQLException {
		super(columnName, propertyConfig, (value == null ? nullValue : value), false);
	}
