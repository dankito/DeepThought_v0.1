...
public interface DatabaseType {
	...
	/**
	 * Takes a {@link com.j256.ormlite.jpa.PropertyConfig} and appends the SQL necessary to create the field to the string builder. The field may
	...
	/**
	 * Takes a {@link com.j256.ormlite.jpa.PropertyConfig} and adds the necessary statements to the before and after lists necessary so that the
	 ...
	 * necessary before it goes to the database.
	 */
	public FieldConverter getFieldConverter(DataPersister dataType, PropertyConfig propertyConfig);
