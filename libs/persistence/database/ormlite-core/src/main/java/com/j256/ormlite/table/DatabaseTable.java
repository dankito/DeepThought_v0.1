 ...
 * change its default joinTableName. You specify this annotation above the classes that you want to persist to the database.
 * For example:
 * 
 * <p>
 * <blockquote>
 * 
 * <pre>
 * &#64;DatabaseTable(joinTableName = "accounts")
