...
public class Where<T, ID> {
	...
	private final PropertyConfig idPropertyConfig;
	...
	Where(EntityConfig<T, ID> entityConfig, StatementBuilder<T, ID> statementBuilder, DatabaseType databaseType) {
		// limit the constructor scope
		this.entityConfig = entityConfig;
		this.statementBuilder = statementBuilder;
		this.idPropertyConfig = entityConfig.getIdProperty();
		if (idPropertyConfig == null) {
			this.idColumnName = null;
		} else {
			this.idColumnName = idPropertyConfig.getColumnName();
		}
	...
	public Where<T, ID> idEq(ID id) throws SQLException {
		...
		addClause(new SimpleComparison(idColumnName, idPropertyConfig, id, SimpleComparison.EQUAL_TO_OPERATION));
		return this;
	}
	...
	public <OD> Where<T, ID> idEq(Dao<OD, ?> dataDao, OD data) throws SQLException {
		...
		addClause(new SimpleComparison(idColumnName, idPropertyConfig, dataDao.extractId(data),
				SimpleComparison.EQUAL_TO_OPERATION));
		return this;
	}
	...
	private PropertyConfig findColumnFieldType(String columnName) {
