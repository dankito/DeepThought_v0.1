...
/**
 * Database connectionSource proxy so you can intercept database operations either for debugging, replication, logging, or
...
public class DatabaseConnectionProxy implements DatabaseConnection {
	...
	public CompiledStatement compileStatement(String statement, StatementType type, PropertyConfig[] argPropertyConfigs,
		...
		if (proxy == null) {
			...
			return proxy.compileStatement(statement, type, argPropertyConfigs, resultFlags);
		}
	}
	...
	public long queryForLong(String statement, Object[] args, PropertyConfig[] argPropertyConfigs) throws SQLException {
		if (proxy == null) {
			...
			return proxy.queryForLong(statement, args, argPropertyConfigs);
		}
	}
