...
public class EagerForeignCollection<T, ID> extends BaseForeignCollection<T, ID> implements CloseableWrappedIterable<T>,
	 ...
	 * instead.
	 */
	public EagerForeignCollection(Dao<T, ID> dao, Object parent, Object parentId, PropertyConfig foreignPropertyConfig,
	...
	public void close() {
		// noop since the iterators aren't holding open a connectionSource
	}
