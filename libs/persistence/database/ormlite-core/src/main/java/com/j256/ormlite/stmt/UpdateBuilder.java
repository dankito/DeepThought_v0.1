...
public class UpdateBuilder<T, ID> extends StatementBuilder<T, ID> {
	...
	public UpdateBuilder(DatabaseType databaseType, EntityConfig<T, ID> entityConfig, Dao<T, ID> dao) {
		super(databaseType, entityConfig, dao, StatementType.UPDATE);
	}
	...
	public UpdateBuilder<T, ID> updateColumnValue(String columnName, Object value) throws SQLException {
		...
		addUpdateColumnToList(columnName, new SetValue(columnName, propertyConfig, value));
		return this;
	}
	...
	public UpdateBuilder<T, ID> updateColumnExpression(String columnName, String expression) throws SQLException {
		...
		addUpdateColumnToList(columnName, new SetExpression(columnName, propertyConfig, expression));
		return this;
	}
