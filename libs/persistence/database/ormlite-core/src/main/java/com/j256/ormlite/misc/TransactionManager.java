...
public class TransactionManager {
	...
	/**
	 * Same as {@link #callInTransaction(Callable)} except as a static method with a connectionSource source.
	 */
	...
	/**
	 * Same as {@link #callInTransaction(Callable)} except as a static method on a connectionSource.
	 */
			...
			try {
				...
				if (hasSavePoint) {
					try {
						...
						logger.error("after commit exception, rolling back to save-point also threw exception", e);
