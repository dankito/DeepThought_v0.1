...
public class MappedQueryForIdTest extends BaseCoreStmtTest {
	...
	public void testQueryNoId() throws Exception {
		StatementExecutor<NoId, String> se =
				new StatementExecutor<NoId, String>(databaseType, new EntityConfig<NoId, String>(connectionSource, null,
						NoId.class), null);
	...
	public void testNoIdBuildUpdater() throws Exception {
		MappedUpdate.build(databaseType, new EntityConfig<NoId, Void>(connectionSource, null, NoId.class));
	}

	@Test(expected = SQLException.class)
	public void testNoIdBuildQueryForId() throws Exception {
		MappedQueryForId.build(databaseType, new EntityConfig<NoId, Void>(connectionSource, null, NoId.class), null);
	}
