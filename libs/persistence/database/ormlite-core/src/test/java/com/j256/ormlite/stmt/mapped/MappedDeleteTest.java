...
public class MappedDeleteTest {
	...
	public void testDeleteNoId() throws Exception {
		StatementExecutor<NoId, Void> se =
				new StatementExecutor<NoId, Void>(databaseType, new EntityConfig<NoId, Void>(connectionSource, null,
						NoId.class), null);
		NoId noId = new NoId();
		noId.stuff = "1";
	...
	public void testNoIdBuildDelete() throws Exception {
		MappedDelete.build(databaseType, new EntityConfig<NoId, Void>(connectionSource, null, NoId.class));
	}
