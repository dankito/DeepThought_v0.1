...
public class DateTypeTest extends BaseTypeTest {
	...
	public void testDateParseInvalid() throws Exception {
		PropertyConfig propertyConfig =
				Instances.getFieldTypeCreator().createFieldType(connectionSource, TABLE_NAME, LocalDate.class.getDeclaredField(DATE_COLUMN),
            LocalDate.class);
		DataType.DATE.getDataPersister().parseDefaultString(propertyConfig, "not valid date string");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testInvalidDateField() throws Exception {
		Instances.getFieldTypeCreator().createFieldType(connectionSource, TABLE_NAME, InvalidDate.class.getDeclaredField("notDate"),
        LocalDate.class);
	}
