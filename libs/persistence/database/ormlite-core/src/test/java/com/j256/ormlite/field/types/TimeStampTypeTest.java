...
public class TimeStampTypeTest extends BaseTypeTest {
	...
	public void testTimeStampParseInvalid() throws Exception {
		PropertyConfig propertyConfig =
				Instances.getFieldTypeCreator().createFieldType(connectionSource, TABLE_NAME,
	...
	public void testInvalidDateField() throws Exception {
		Instances.getFieldTypeCreator().createFieldType(connectionSource, TABLE_NAME, InvalidDate.class.getDeclaredField("invalidType"),
        LocalDate.class);
	}
