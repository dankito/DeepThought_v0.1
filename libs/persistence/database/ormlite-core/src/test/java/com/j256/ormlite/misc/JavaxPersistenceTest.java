...
public class JavaxPersistenceTest extends BaseCoreTest {
	...
	public void testConversions() throws Exception {
      ...
      // cda: here as well, there's no @OneToMany equivalent to @ManyToOne, so this must fail
...
//				assertNull(config.getColumnName());
//				assertNull(config.getColumnDefinition());
        assertEquals("", config.getColumnName());
        assertEquals("", config.getColumnDefinition());
	...
	public void testTableName() {
		...
		assertEquals(EntityNoName.class.getSimpleName().toLowerCase(), configurer.getEntityName(EntityNoName.class));
	}
