...
public class QueryBuilderTest extends BaseCoreStmtTest {
	...
	public void testSelectAll() throws Exception {
		QueryBuilder<Foo, Integer> qb = new QueryBuilder<Foo, Integer>(databaseType, baseFooEntityConfig, null);
	...
	public void testLimitAfterSelect() throws Exception {
		QueryBuilder<Foo, Integer> qb =
				new QueryBuilder<Foo, Integer>(new LimitAfterSelectDatabaseType(), baseFooEntityConfig, null);
		long limit = 103;
		qb.limit(limit);
		StringBuilder sb = new StringBuilder();
	...
	public void testLimitInline() throws Exception {
		QueryBuilder<Foo, Integer> qb = new QueryBuilder<Foo, Integer>(new LimitInline(), baseFooEntityConfig, null);
		long limit = 213;
		qb.limit(limit);
		PreparedQuery<Foo> stmt = qb.prepare();
		stmt.getStatement();
