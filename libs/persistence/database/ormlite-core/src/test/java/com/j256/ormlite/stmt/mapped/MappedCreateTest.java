...
public class MappedCreateTest extends BaseCoreStmtTest {
	...
	public void testGeneratedId() throws Exception {
		EntityConfig<GeneratedId, Integer> entityConfig =
				new EntityConfig<GeneratedId, Integer>(connectionSource, null, GeneratedId.class);
		StatementExecutor<GeneratedId, Integer> se =
				new StatementExecutor<GeneratedId, Integer>(databaseType, entityConfig, null);
		DatabaseConnection databaseConnection = createMock(DatabaseConnection.class);
		databaseConnection.insert(isA(String.class), isA(Object[].class), isA(PropertyConfig[].class),
	...
	public void testGeneratedIdSequenceLong() throws Exception {
		...
		StatementExecutor<GeneratedIdLong, Long> se =
				new StatementExecutor<GeneratedIdLong, Long>(databaseType, new EntityConfig<GeneratedIdLong, Long>(
	...
	public void testNoCreateSequence() throws Exception {
		MappedCreate.build(databaseType, new EntityConfig<GeneratedId, Integer>(connectionSource, null, GeneratedId.class));
	}
	...
	public void testSequenceZero() throws Exception {
		...
		MappedCreate<GeneratedIdSequence, Integer> mappedCreate =
				MappedCreate.build(needsSequence, new EntityConfig<GeneratedIdSequence, Integer>(connectionSource, null,
	...
	public void testArgumentHolderDoubleSet() throws Exception {
		...
		MappedCreate<Foo, Integer> mappedCreate = MappedCreate.build(databaseType, entityConfig);
		DatabaseConnection conn = createMock(DatabaseConnection.class);
		expect(
				conn.insert(isA(String.class), isA(Object[].class), isA(PropertyConfig[].class),
