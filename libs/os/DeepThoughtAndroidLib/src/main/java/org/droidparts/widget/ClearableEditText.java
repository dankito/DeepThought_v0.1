// Modified copy of https://github.com/yanchenko/droidparts/blob/develop/droidparts/src/org/droidparts/widget/ClearableEditText.java
/**
...
public class ClearableEditText extends EditText implements OnTouchListener, OnFocusChangeListener, TextWatcherListener {
  ...
  public void onFocusChange(View v, boolean hasFocus) {
    if (hasFocus) {
      setClearIconVisible(StringUtils.isNotNullOrEmpty(getText().toString()));
    } else {
  ...
  public void onTextChanged(EditText view, String text) {
    if (isFocused()) {
      setClearIconVisible(StringUtils.isNotNullOrEmpty(text));
    }
  }
  ...
  private void initIcon() {
    ...
    if (xD == null) {
      xD = getResources().getDrawable(android.R.drawable.ic_menu_close_clear_cancel);
    }
