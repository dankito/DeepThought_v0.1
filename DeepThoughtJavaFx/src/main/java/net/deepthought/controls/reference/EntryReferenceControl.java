...
//  }
  ...
  protected void setupPaneReferenceIndicationSettings() {
    ...
    cmbxReferenceIndicationStartUnit.setValue(entry.getReferenceStartUnit());
    ...
    cmbxReferenceIndicationEndUnit.setValue(entry.getReferenceEndUnit());
    ...
    paneReferenceIndicationEndSettings.setDisable(true);
  }
...
//      entry.setReferenceEndUnit(newValue);
  ...
  protected EntityListener entryListener = new EntityListener() {
    ...
    public void propertyChanged(BaseEntity entity, String propertyName, Object previousValue, Object newValue) {
      ...
      else if(propertyName.equals(TableConfig.EntryReferenceStartUnitJoinColumnName)) {
        updateComboBoxReferenceStartUnitSelectedItem((ReferenceIndicationUnit) newValue);
      }
      else if(propertyName.equals(TableConfig.EntryReferenceEndUnitJoinColumnName)) {
