...
import net.dankito.deepthought.controls.backup.BackupRestoreProgressMessageTableCell;
import net.dankito.deepthought.controls.backup.BackupRestoreProgressStateTableCell;
import net.dankito.deepthought.data.backup.BackupFile;
import net.dankito.deepthought.data.backup.IBackupFileService;
import net.dankito.deepthought.data.backup.RestoreBackupParams;
 ...
 */
public class RestoreBackupDialogController extends net.dankito.deepthought.controller.ChildWindowsController implements Initializable {
    ...
    return new RestoreBackupListener() {
      ...
      public List<BaseEntity> selectEntitiesToRestore(BackupFile file, final BaseEntity restoredData) {
        ...
        Platform.runLater(new Runnable() {
          @Override
          public void run() {
            Dialogs.showSelectEntitiesToImportDialog(restoredData, windowStage, new net.dankito.deepthought.controller.ChildWindowsControllerListener() {
              @Override
