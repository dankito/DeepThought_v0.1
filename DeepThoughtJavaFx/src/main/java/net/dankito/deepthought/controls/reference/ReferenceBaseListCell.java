...
public class ReferenceBaseListCell extends ListCell<ReferenceBase> implements ICleanUp {
  ...
  protected ContextMenu createContextMenu() {
    ...
    editReferenceBaseItem.setOnAction(actionEvent -> net.dankito.deepthought.controller.Dialogs.showEditReferenceDialog(referenceBase));
  ...
  protected void deleteReferenceBase() {
    if(net.dankito.deepthought.util.Alerts.deleteReferenceBaseWithUserConfirmationIfIsSetOnEntries(referenceBase)) {
  ...
  protected void addNewReferenceToSeriesTitle(final SeriesTitle seriesTitle) {
    ...
    net.dankito.deepthought.controller.Dialogs.showEditReferenceDialog(newReference, seriesTitle, new ChildWindowsControllerListener() {
      @Override
  ...
  protected void addNewSubDivisionToReference(final Reference reference) {
    ...
    net.dankito.deepthought.controller.Dialogs.showEditReferenceDialog(newSubDivision, reference, new ChildWindowsControllerListener() {
      @Override
      public void windowClosing(Stage stage, ChildWindowsController controller) {
        if (controller.getDialogResult() == DialogResult.Ok)
  ...
  protected void editReferenceBase() {
    net.dankito.deepthought.controller.Dialogs.showEditReferenceDialog(getItem());
  }
