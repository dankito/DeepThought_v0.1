...
public class PersonListCell extends ListCell<Person> implements ICleanUp {
  ...
  protected ContextMenu createContextMenu() {
    ...
    editTagItem.setOnAction(actionEvent -> net.dankito.deepthought.controller.Dialogs.showEditPersonDialog(getItem() == null ? person : getItem()));
  ...
  protected void handleButtonEditPersonAction() {
    net.dankito.deepthought.controller.Dialogs.showEditPersonDialog(getItem());
  }
