...
import net.dankito.deepthought.communication.messages.response.ResponseToAsynchronousRequest;
...
public class MessagesReceiver extends NanoHTTPD {
  ...
  protected Response handleRequest(String methodName, Request request) {
    try {
      ...
      return createResponse(Response.Status.BAD_REQUEST, net.dankito.deepthought.communication.messages.response.Response.Denied);
    } catch(Exception ex) {
  ...
  protected Response createResponse(net.dankito.deepthought.communication.messages.response.Response response) {
    return createResponse(Response.Status.OK, response);
  }

  protected Response createResponse(Response.IStatus status, net.dankito.deepthought.communication.messages.response.Response response) {
...
//    else
  ...
  protected Response createOkResponse() {
    return createResponse(net.dankito.deepthought.communication.messages.response.Response.OK);
  }

  protected Response createInvalidUrlResponse() {
    return createResponse(Response.Status.NOT_FOUND, new net.dankito.deepthought.communication.messages.response.Response(ResponseCode.Error, "Method not found"));
  }

  protected Response createCouldNotDeserializeRequestResponse() {
    return createResponse(Response.Status.BAD_REQUEST, net.dankito.deepthought.communication.messages.response.Response.CouldNotDeserializeRequest);
  }

  protected Response createCouldNotHandleRequestResponse() {
    return createResponse(Response.Status.INTERNAL_ERROR, net.dankito.deepthought.communication.messages.response.Response.CouldNotHandleRequest);
  }


  protected String serializeResponse(net.dankito.deepthought.communication.messages.response.Response response) {
