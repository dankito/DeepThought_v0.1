...
import net.dankito.deepthought.data.persistence.deserializer.JsonIoDataDeserializer;
import net.dankito.deepthought.data.persistence.serializer.SerializationResult;
import net.dankito.deepthought.data.persistence.db.BaseEntity;
import net.dankito.deepthought.data.persistence.serializer.JsonIoDataSerializer;
